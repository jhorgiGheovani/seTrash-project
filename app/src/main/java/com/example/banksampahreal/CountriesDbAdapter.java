...
public class CountriesDbAdapter {
    ...
    public void insertSomeCountries() {
        ...
        createCountry("#ezx55fd","Kardus","Organik","Rp 9.500");
        createCountry("#yb72uhx","Kertas","Organik","Rp 8.700");
        createCountry("#msbks43","Makanan/Sayuran Bekas","Organik","Rp 7.900");
        createCountry("#x059yzz","Besi/Alumunium","Anorganik","Rp 14.300");
        createCountry("#xca237y","Kaca","Anorganik","Rp 10.000");
        createCountry("#iks6dd9","Botol Bekas","Anorganik","Rp 8.100");
        createCountry("#88yuksz","Barang Elektronik","Anorganik","Rp 13.900");
